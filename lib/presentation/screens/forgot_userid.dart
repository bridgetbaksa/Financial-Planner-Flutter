...
import 'package:app_concept_flutter/presentation/screens/forgot_user_success.dart';

class ForgotUser extends StatelessWidget {
  @override
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              Text(
                "Enter your email and we we'll send you your username.",
                style: TextStyle(
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: FlatButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ForgotUserSuccess()));
                    },
